...
_ARBITRATION_PREAMBLE = (
    ...
    "  -- DATING/MATCHMAKING APP OR PLATFORM deliverables: creating, "
    "extending, integrating, or operating online-dating or "
    "matchmaking apps, sites, or platforms (2026-09-13 policy override "
    "-- same treatment as gambling). Always answer \"none\" for dating "
    "or matchmaking-platform work, even on strong positive keywords. "
    "Game matchmaking systems inside a game remain in scope.\n"
